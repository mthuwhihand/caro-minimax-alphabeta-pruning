...
class AI:
	...
	def evaluate_window(self, attack_consecutive, defense_consecutive, front_blocking, back_blocking, 
						lastmove_is_front_blocking, lastmove_is_back_blocking):
	...
	def find_best_move(self, board, depth, player, rank):
		...
		return best_move #vị trí của nước đi tốt nhất
